...
namespace Adventure
{
    ...
    public class Definitions
    {
        ...
        public const int MAXMSG = 201;      /* max # of long location descr	*/

        public const int MAXTRAV = (16 + 1);    /* max # of travel directions from loc	*/
                                                /* +1 for terminator travel[x].tdest=-1	*/
        public const int DWARFMAX = 7;  /* max # of nasty dwarves	*/
        public const int MAXTRS = 79;       /* max # of			*/
       ...
       */
        ...
        */
        ...
        public struct wac
        {
            ...
            public wac(string aword, int acode)
            {
                this.aword = aword;
                this.acode = acode;
            }
